        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('brokers.index') }}"
                    class="flex items-center p-2 rounded-lg
                        {{ request()->routeIs('brokers.index') ? 'bg-blue-600 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group' }}">
                    <svg class="flex-shrink-0 w-5 h-5
                        {{ request()->routeIs('brokers.index') ? 'text-white' : 'text-gray-500' }}
                        transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        viewBox="0 0 18 18">
                        <path
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Brokers</span>
                    {{-- <span
